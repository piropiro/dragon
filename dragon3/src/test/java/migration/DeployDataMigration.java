...
public class DeployDataMigration {
    ...
    public void migrate_002() throws Exception {
    	...
    	for (String fileName : getFileNames()) {
    		DeployData[] dataList = JsonIO.read("dragon3/data/deploy/deploy_" + fileName + ".json", DeployData[].class);
    		int[][] map = JsonIO.read("dragon3/data/map/map_" + fileName + ".json", int[][].class);
